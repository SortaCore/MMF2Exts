    ...
    : rdPtr(_rdPtr), rhPtr(_rdPtr->rHo.hoAdRunHeader), Runtime(_rdPtr)
{
    ...
    */
    ...
    LinkAction(0, ConvertToMFU);
    LinkAction(1, ConvertToCNC);

    LinkCondition(0, AlwaysTrue);
	LinkCondition(1, AlwaysTrue);

    LinkExpression(0, GetFormat);
	LinkExpression(1, GetLastConverted);
	LinkExpression(2, GetLastError);
