    ...
    : rdPtr(_rdPtr), rhPtr(_rdPtr->rHo.hoAdRunHeader), Runtime(_rdPtr)
{
    ...
    */
    ...
    LinkAction(0, IterateString);
    LinkAction(1, IterateRanges);

    LinkCondition(0, OnIteration);

	LinkExpression(0, StringToRange);
    LinkExpression(1, RangeToString);
	LinkExpression(2, CurrentIteratedValue);
