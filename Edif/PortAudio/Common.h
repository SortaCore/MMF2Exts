...
{
	wchar_t ret [255] (L"\0");
	MultiByteToWideChar(CP_UTF8 /* CP_ACP */, NULL, var, -1, ret, 255);
	return ret;
}
...
#include "..\Lib\PortAudio_SDK\PortAudio.h"
#ifdef _DEBUG
#pragma comment(lib, "..\\Lib\\PortAudio_SDK\\portaudio_dbg.lib")
#else
#pragma comment(lib, "..\\Lib\\PortAudio_SDK\\portaudio.lib")
#endif
// dsound.lib is in Windows SDK. VS should auto-path it.
// If not, install Windows 7.1 SDK.
