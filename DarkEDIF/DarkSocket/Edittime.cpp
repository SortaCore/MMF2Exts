...
{
#ifndef RUN_ONLY
	if (cpt > 1) // 2+ objects created in frame
	{
		MessageBox(NULL, _T("DarkSocket has been duplicated! Please note this may cause severe"
							"errors when instances of DarkSocket collide.\n"
							"A single DarkSocket instance is capable of running 256 client/server sockets at once.\n"
							"You should remove the newly created instance and just use one."),
							"DarkSocket notice:", MB_OK);
	}
#endif // !defined(RUN_ONLY)
}
