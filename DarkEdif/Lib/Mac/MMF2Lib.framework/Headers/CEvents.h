...
#define CNDL_RUNNINGAS			((-40<<16)|65535)
...
#define ACT_STARTPROFILING	((39<<8)|255)
#define ACTL_STARTPROFILING	((39<<16)|65535)
#define ACT_STOPPROFILING	((40<<8)|255)
#define ACTL_STOPPROFILING	((40<<16)|65535)
#define ACT_CLEARDEBUGOUTPUT	((41<<8)|255)
#define ACTL_CLEARDEBUGOUTPUT	((41<<16)|65535)
#define ACT_DEBUGOUTPUT		((42<<8)|255)
#define ACTL_DEBUGOUTPUT	((42<<16)|65535)
#define ACT_EXECUTECHILDEVENTS	((43<<8)|255)
#define ACTL_EXECUTECHILDEVENTS	((43<<16)|65535)
...
#define CND_EXTCMPINSTANCEDATA		(-49<<8)
#define CNDL_EXTCMPINSTANCEDATA		(-49<<16)
#define CND_EXTPICKMAXVALUE			(-48<<8)
#define CNDL_EXTPICKMAXVALUE		(-48<<16)
#define CND_EXTPICKMINVALUE			(-47<<8)
#define CNDL_EXTPICKMINVALUE		(-47<<16)
#define	CND_EXTCMPLAYER	   			(-46<<8)
#define	CNDL_EXTCMPLAYER			(-46<<16)
#define	CND_EXTCOMPARE				(-45<<8)
#define	CNDL_EXTCOMPARE				(-45<<16)
#define	CND_EXTPICKCLOSEST			(-44<<8)
#define	CNDL_EXTPICKCLOSEST			(-44<<16)
...
#define	ACT_EXTEXT					(80<<8)
#define	ACTL_EXTEXT					(80<<16)
...
#define EXP_EXTGETANGULARVELOCITY	(43<<8)
#define EXP_EXTGETNAME				(44<<8)
#define EXP_NUMBEROFSELECTED		(45<<8)
#define EXP_EXTINSTANCEDATA			(46<<8)
...
/////////////////////////////////////////////
#define	CND_CMPSCALEY	   	(((-EVENTS_EXTBASE-4)<<8)|2)
#define	CNDL_CMPSCALEY	   	(((-EVENTS_EXTBASE-4)<<16)|2)
#define	CND_CMPSCALEX	   	(((-EVENTS_EXTBASE-3)<<8)|2)
#define	CNDL_CMPSCALEX	   	(((-EVENTS_EXTBASE-3)<<16)|2)
#define	CND_CMPANGLE	   	(((-EVENTS_EXTBASE-2)<<8)|2)
#define	CNDL_CMPANGLE	   	(((-EVENTS_EXTBASE-2)<<16)|2)
#define	CND_SPRCLICK	   	(((-EVENTS_EXTBASE-1)<<8)|2)		// No longer used (apparently used only in unofficial pre-versions of MMF1 (might concern old MMF1 examples)
...
typedef struct tagPRG {
    short   prgFlags;
    unichar prgPath[260];           // MAX_PATH
    unichar prgCommand[108];        // 108? wtf...
} prgParam;
...
void actPlayMusic(event* pe, CRun* rhPtr);
void actStopMusic(event* pe, CRun* rhPtr);
void actPlayLoopMusic(event* pe, CRun* rhPtr);
void actPauseMusic(event* pe, CRun* rhPtr);
void actResumeMusic(event* pe, CRun* rhPtr);

void actPlayMusicFile(event* pe, CRun* rhPtr);
void actPlayLoopMusicFile(event* pe, CRun* rhPtr);
void actPlaySampleFile(event* pe, CRun* rhPtr);
void actPlayLoopSampleFile(event* pe, CRun* rhPtr);
...
void actFullScreenMode(event* pe, CRun* rhPtr);
void actWindowedMode(event* pe, CRun* rhPtr);
void actPauseKey(event* pe, CRun* rhPtr);
...
void actPla_SetInputType(event* pe, CRun* rhPtr);
void actPla_SetInputKey(event* pe, CRun* rhPtr);
void expPla_GetInputType(CRun* rhPtr);
void expPla_GetInputKey(CRun* rhPtr);
...
BOOL evaMenuSelected1(event* pe, CRun* rhPtr, LPHO pHo);
BOOL evaMenuSelected2(event* pe, CRun* rhPtr, LPHO pHo);
BOOL evaMenuChecked(event* pe, CRun* rhPtr, LPHO pHo);
BOOL evaMenuEnabled(event* pe, CRun* rhPtr, LPHO pHo);
BOOL evaMenuVisible(event* pe, CRun* rhPtr, LPHO pHo);
BOOL evaIsClipText(event* pe, CRun* rhPtr, LPHO pHo);
void actSendClipboard(event* pe, CRun* rhPtr);
void actClearClipboard(event* pe, CRun* rhPtr);
void expSys_GetClipboard(CRun* rhPtr);
BOOL evaOnGroupStart(event* pe, CRun* rhPtr, LPHO pHo);
void actMenuActivate(event* pe, CRun* rhPtr);
void actMenuDeactivate(event* pe, CRun* rhPtr);
void actMenuCheck(event* pe, CRun* rhPtr);
void actMenuUncheck(event* pe, CRun* rhPtr);
void actMenuShow(event* pe, CRun* rhPtr);
void actMenuHide(event* pe, CRun* rhPtr);
void actMenuSendCmd(event* pe, CRun* rhPtr);
...
void actExecProgram(event* pe, CRun* rhPtr);
void actExecProgram2(event* pe, CRun* rhPtr);
...
void expSys_Drive(CRun* rhPtr);
void expSys_Dir(CRun* rhPtr);
void expSys_Path(CRun* rhPtr);
void expSys_AppName(CRun* rhPtr);
void exp_notImpl_String(CRun* rhPtr);
void exp_notImpl_Num(CRun* rhPtr);
...
void actSpriteLoadFrame(event* pe, CRun* rhPtr);
...
BOOL evaMouseShown(event* pe, CRun* rhPtr, LPHO pHo);
BOOL evaOnMouseWheelUp(event* pe, CRun* rhPtr, LPHO pHo);
BOOL evaOnMouseWheelDown(event* pe, CRun* rhPtr, LPHO pHo);
void expMouseWheelDelta(CRun* rhPtr);
void actShowCursor(event* pe, CRun* rhPtr);
void actHideCursor(event* pe, CRun* rhPtr);
