...
enum
{
	...
	DCS_DEGREES		= 0x20,		// CF2.5: Display degrees instead of direction numbers
};
...
typedef struct {
	...
	unsigned int	style;		// Style DCS_NOBORDER, DCS_FLAT, DCS_3D, [DCS_SLIDER,] DCS_EMPTY, DCS_SETALL_BTNS, DCS_DEGREES
} DirCtrlCreateParam;
...
enum {
	...
	PROPID_TAB_ABOUT,
	// MMF2: BluRay
	PROPID_TAB_MMF2_BLURAY,
	// CF2.5: UWP exporter
	PROPID_TAB_CF25_WUA = PROPID_TAB_MMF2_BLURAY,
	PROPID_TAB_IPHONE,
	PROPID_TAB_ANDROID,
	PROPID_TAB_XNA,
	PROPID_TAB_MAC,
	// MMF2 only: smiling face emote tab
	PROPID_TAB_MMF2_CUSTOM1 = 18,
	// MMF2 only: calendar icon tab
	PROPID_TAB_MMF2_CUSTOM2,
	
	// CF2.5: Flash exporter
	PROPID_TAB_FLASH,
	PROPID_TAB_WINDOWS,
	// CF2.5 Custom tab
	PROPID_TAB_CF25_CUSTOM1 = 20,
	PROPID_TAB_CF25_CUSTOM2,
	PROPTAB_MAX				// 22
};
...
enum {
	...
	PROPID_DYNITEM_PRELOADTEXTURES,
	...
	PROPID_DYNITEM_ALTVALUE_LAST =0x50103, // MMF2: 0x50019

	PROPID_DYNITEM_ALTSTRING_FIRST=0x50400, // MMF2: 0x50800
	PROPID_DYNITEM_ALTSTRING_LAST =0x50503, // MMF2: 0x50809
...
enum {
	...
	PROPID_APP_ANDROID_PERM_LAST = 90193,
