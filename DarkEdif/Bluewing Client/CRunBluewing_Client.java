/* File generated by AltPlatformPostBuildTool, part of DarkEDIF SDK. 
...
public class CRunBluewing_Client extends CRunExtension
{
	...
	public CRunBluewing_Client()
	{
		if (!inited)
		{
			...
			if (inited)
			{
				shutdownThread = new Thread(javaVMShutdownHandler);
	...
	public native int darkedif_getNumberOfConditions(int cptr);
	...
	public native int darkedif_createRunObject(ByteBuffer edPtr, CCreateObjectInfo cob, int version);
	...
	public native short darkedif_handleRunObject(int cptr);
	...
	public native short darkedif_displayRunObject(int cptr);
	...
	public native void darkedif_destroyRunObject(int cptr, boolean fast);
	...
	public native short darkedif_pauseRunObject(int cptr);
	...
	public native short darkedif_continueRunObject(int cptr);
	...
	public native boolean darkedif_condition(int cptr, int num, CCndExtension cnd);
	...
	public native void darkedif_action(int cptr, int num, CActExtension act);
	...
	private native void darkedif_expression(int cptr, int num, CNativeExpInstance exp);
	
	// JavaVM shutdown handler. Fusion doesn't appear to have a way of notifying native exts if app is closing down.
	public static void javaVMShutdownHandler()
	{
		darkedif_endapp();
	}
	private native void darkedif_endapp();
};
