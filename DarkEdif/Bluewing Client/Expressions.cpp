...
const TCHAR * Extension::ConvToUTF8_TestAllowList(const TCHAR * toTest, const TCHAR * charset)
{
	lacewing::codepointsallowlist list;
	const std::string err = list.setcodepointsallowedlist(TStringToUTF8(charset));
	if (!err.empty())
